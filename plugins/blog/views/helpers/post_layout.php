<?php
    ...
    class PostLayoutHelper extends BlogHelper
    {
        ...
        */
        ...
        function indexPostHead()
        {
            $out  = '<div class="header">'.
                       '<h3>'.$this->data['Post']['title'].'</h3>';
                        $out .= '<div class="date">'.$this->Time->{$this->dateFormat}( $this->data['Post']['created'] ).'</div>';
            $out .= '</div>';
         ...
         *  - more :: show / view more
         *
         * @todo -cLayoutHelper Implement LayoutHelper.
         *  - pdf
         *  - print css
         *  - share on fb
         *  - retweet on twitter
        ...
        function viewPostHead( $params = array( 'comments', 'date', 'views' ), $seperator = ' :: ' )
        {
            ...
            $out .= '<p><small>';
                foreach( $params as $param )
                {
                    ...
                    {
                        case 'date':
                        $temp[] = sprintf( '%s: %s', __( 'Created', true ), $this->Time->{$this->dateFormat}( $this->data['Post']['created'] ) );
                            break;
        ...
        */
         ...
         *
         * @todo -cPostLayoutHelper Implement PostLayoutHelper. make this work
