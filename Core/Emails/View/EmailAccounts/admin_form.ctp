<?php
	...
	echo $this->Form->create('EmailAccount');
		...
		<fieldset>
			<h1><?php echo __('Outgoing'); ?></h1><?php
		...
		<fieldset>
			...
			<div class="input select smaller">
				<label for=""><?php echo __('Connection Type'); ?></label><?php
			...
			<?php
				$params = array(
					'plugin' => 'assets',
					'message' => __('The following is only a guide, please check your server as it may be different')
				);
				echo $this->element('messages/warning', $params);
			?>
			<table style="width: 300px; margin: auto;">
				<tr><th><?php echo __('Port'); ?></th><th><?php echo __('Use'); ?></th></tr>
				<tr><td>110</td><td><?php echo __('Standard POP3 port / MMP POP3 Proxy'); ?></td></tr>
				<tr><td>992</td><td><?php echo __('POP3 over SSL'); ?></td></tr>
				<tr><td>143</td><td><?php echo __('Standard IMAP4 port / MMP IMAP Proxy'); ?></td></tr>
				<tr><td>993</td><td><?php echo __('IMAP over SSL or MMP IMAP Proxy over SSL'); ?></td></tr>
				<tr><td> 25</td><td><?php echo __('Standard SMTP port'); ?></td></tr>
				<tr><td>465</td><td><?php echo __('Standard SMTP port'); ?></td></tr>
			</table>
		</fieldset>
