<?php
	...
	class R4f56323e260c44679ec440726318cd70 extends CakeRelease {
	...
	* @access public
	*/
		public $description = 'Migration for Contact version 0.9';
	...
	*/
		...
		'down' => array(
			'drop_table' => array(
				'contact_addresses', 'contact_branches', 'contact_contacts', 'contact_countries'
			),
		),
		);
