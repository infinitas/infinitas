...
defaults('ADMIN_PASSWORD','password123');  	// Admin Password - CHANGE THIS TO ENABLE!!!

// (beckerr) I'm using a clear text password here, because I've no good idea how to let users generate a md5 or crypt password in a easy way to fill it in above
...
EOB;
echo menu_entry(1,'View Host Stats'), menu_entry(2,'System Cache Entries');
if ($AUTHENTICATED) {
	echo menu_entry(4,'Per-Directory Entries');
}

echo menu_entry(3,'User Cache Entries'), menu_entry(9,'Version Check');
...
case OB_HOST_STATS:
	...
	$i=0;
	echo <<< EOB
		<div class="info div1"><h2>General Cache Information</h2><table cellspacing=0><tbody>
...
EOB;
	...
	echo '</tbody></table></div><div class="graph div3"><h2>Host Status Diagrams</h2><table cellspacing=0><tbody>';
	$size = 'width='.(GRAPH_SIZE+50).' height='.(GRAPH_SIZE+10);
	echo '<tr><td class=td-0>' . $mem_note . '</td><td class=td-1>Hits &amp; Misses</td></tr>';
