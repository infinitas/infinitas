...
if (!empty($associations['hasOne'])) :
	...
	<div class="related">
		<h3><?php echo "<?php printf(__('Related %s'), __('" . Inflector::humanize($details['controller']) . "'));?>";?></h3>
	...
	<?php echo "<?php endif; ?>\n";?>
		<div class="actions">
			<ul>
				<li><?php echo "<?php echo \$this->Html->link(sprintf(__('Edit %s'), __('" . Inflector::humanize(Inflector::underscore($alias)) . "')), array('controller' => '{$details['controller']}', 'action' => 'edit', \${$singularVar}['{$alias}']['{$details['primaryKey']}'])); ?></li>\n";?>
			</ul>
		</div>
	</div>
	<?php
...
foreach ($relations as $alias => $details):
	...
	?>
<div class="related">
	<h3><?php echo "<?php printf(__('Related %s'), __('{$otherPluralHumanName}'));?>";?></h3>
	<?php echo "<?php if (!empty(\${$singularVar}['{$alias}'])):?>\n";?>
...
<?php echo "<?php endif; ?>\n\n";?>
	<div class="actions">
		<ul>
			<li><?php echo "<?php echo \$this->Html->link(sprintf(__('New %s'), __('" . Inflector::humanize(Inflector::underscore($alias)) . "')), array('controller' => '{$details['controller']}', 'action' => 'add'));?>";?> </li>
		</ul>
	</div>
</div>
<?php endforeach;?>