<?php
/**
 * @brief fixture file for ModulesRoute tests.
 *
...
class ModulesRouteFixture extends CakeTestFixture {
	...
	public $fields = array(
		...
		'indexes' => array(
			...
			'habtm' => array('column' => array('route_id', 'module_id'), 'unique' => 1),
			'route' => array('column' => 'route_id', 'unique' => 0),
			'module' => array('column' => 'module_id', 'unique' => 0)
		),
