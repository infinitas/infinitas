jQuery.fn.calendarPicker = function(options) {
  ...
  if (typeof(options.monthNames) == "undefined"){options.monthNames = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];}

  if (typeof(options.dayNames) == "undefined"){options.dayNames = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];}
  ...
  calendar.changeDate = function(date) {
    ...
    var fillYears = function(date) {
      ...
      for (var i = year - options.years; i <= year + options.years; i++) {
        ...
        if (d.getYear() == t.getYear()){span.addClass("today");}
        if (d.getYear() == calendar.currentDate.getYear()){span.addClass("selected");}
    ...
    var fillMonths = function(date) {
      ...
      for (var i = -options.months; i <= options.months; i++) {
        ...
        if ((d.getYear() == t.getYear()) && (d.getMonth() == t.getMonth())){span.addClass("today");}
        if ((d.getYear() == calendar.currentDate.getYear()) && (d.getMonth() == calendar.currentDate.getMonth())){span.addClass("selected");}
    ...
    var fillDays = function(date) {
      ...
      for (var i = -options.days; i <= options.days; i++) {
        ...
        if ((i == -options.days) && options.showDayArrows) {
          ...
          if ((d.getYear() == t.getYear()) && (d.getMonth() == t.getMonth()) && (d.getDate() == t.getDate())){span.addClass("today");}
          if ((d.getYear() == calendar.currentDate.getYear()) && (d.getMonth() == calendar.currentDate.getMonth()) && (d.getDate() == calendar.currentDate.getDate())){span.addClass("selected");}
        }
        divDays.append(span);
